<section>
    ...
    <div class="flex mt-4 gap-6">
        ...
        <div class="flex flex-col items-center">
            <img src="{{ asset('storage/app/public'.Auth::user()->img_path) }}" alt="Profile Image" class="w-32 h-32 rounded-full border border-gray-300 dark:border-gray-700">
            <!-- Image upload form -->
            <form action="{{ route('profile.update_image') }}" enctype="multipart/form-data" class="mt-4">
                @csrf
                <label for="img_path" class="cursor-pointer flex items-center">
