<section class="max-w-full">
    <header>
        <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100 mt-3 ml-11">
            <!-- ここに文字を入力する -->
            {{ __('パスワードを更新する') }}
        </h2>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 w-full flex flex-col items-center">
        @csrf
        @method('put')
        ...
        <div class="flex items-center gap-4 w-full max-w-md mt-4">
